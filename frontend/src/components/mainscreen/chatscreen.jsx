...
function Chatscreen({ currChat, chats }) {
  ...
  return (
    currChat && chats ? (
      <div className='w-[91.6%] bg-gray-900 mt-3 p-2 rounded-lg flex flex-col h-[88.5vh] m-2'>
        <div className='w-[100%] bg-gray-700 h-10 rounded-lg text-white font-bold flex'>
          <img 
            src={currChat.pic} 
            ...
            >
              <span 
                className={`px-3 py-2 m-1 max-w-[60%] break-words rounded-lg opacity-100 ${
                  message.sender && message.sender._id !== currChat.userId ? 'bg-blue-600 text-white' : 'bg-green-600 text-white'
                }`}
              > 
                {message.content}
              </span>
        ...
        <div className='mt-auto'>
          <input 
            ...
            className='border-2 border-gray-600 rounded-lg w-[100%] p-1 text-white bg-gray-800'
            value={newMessage}
      ...
      <div className='w-[91.6%] bg-gray-800 mt-3 p-2 ml-2 mr-2 rounded-lg flex justify-center items-center h-[88.5vh]'>
        <p className='text-gray-400 font-bold text-[2.5rem]'>Start the chat</p>
      </div>
    )
  );
}
